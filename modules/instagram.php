...
<div class="module-card">
    ...
    <form class="dashboard-search-form" data-module="instagram" method="POST" action="">
        <div class="form-group">
            <label class="form-label"><i class="fab fa-instagram"></i> Enter username</label>
...
<div id="results-instagram" class="module-results"></div>
